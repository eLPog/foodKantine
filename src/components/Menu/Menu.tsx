  ...
  return (
    <nav className="nav__container container">
      ...
      <ul className="nav__container__menu__list">
        ...
        <NavLink to="/code">
          <li className="nav__container__menu__list__li" title="Code examples">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <NavLink to="/appHistory">
          <li className="nav__container__menu__list__li" title="Development history">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
